    ...
    <div>
     ...
     <x-navbar />
      ...
      <section class="nft-grid">
        <img src="{{ asset('images/NFT1.png')}}" alt="NFT"/>
       <img src="{{ asset('images/GlossyDuckNFT.png')}}" alt="glossy duck NFT"/>
        <img src="{{ asset('images/NFT-small.png')}}" alt="NFT"/>
        <img src="{{ asset('images/GlossySquirrelNFT.png')}}" alt="GlossySquirrel NFT"/>
      </section>
